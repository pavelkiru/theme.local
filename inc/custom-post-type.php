...
if( @$contact == 1 ){
  ...
  add_filter('manage_sunset_contact_posts_columns', 'sunset_set_contact_columns');
  add_action('manage_sunset_contact_posts_custom_column', 'sunset_contact_custom_column',10,2);
...
function sunset_contact_add_meta_box() {
  add_meta_box('contact_email', 'User Email','sunset_contact_email_callback','sunset_contact','side');
}
